...
import ar.edu.uces.progweb2.springmvc.dto.FormRegisterDTO;
...
public class UsuarioController {
	...
	public String procesarFormUsuario (@ModelAttribute("usuarioForm") UsuarioFormDTO usuarioForm, ModelMap model, BindingResult result ) {
	...
	public String procesarRegister(@ModelAttribute("formRegister") FormRegisterDTO formRegister, ModelMap model) {
